 ...
 * 
 */
@WebServiceClient(name = "TestWS", targetNamespace = "http://ws.itver/", wsdlLocation = "http://localhost:8080/SD_WS_EneJun2019_2/TestWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTWS_QNAME = new QName("http://ws.itver/", "TestWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SD_WS_EneJun2019_2/TestWS?wsdl");
    ...
    public TestWS getTestWSPort() {
        return super.getPort(new QName("http://ws.itver/", "TestWSPort"), TestWS.class);
    }
    ...
    public TestWS getTestWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.itver/", "TestWSPort"), TestWS.class, features);
    }
